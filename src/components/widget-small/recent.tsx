...
export default function Recent() {
	return (
		<Flex mt={'16px'} flexDirection={'column'} justifyContent={'space-between'} p={'14px 23px'} bg={'white'} width={284} height={264} borderRadius={16}>
			<Text as={'h2'} color={'hsla(0, 0%, 20%, 0.8)'} fontWeight={500} fontSize={12}>Recent</Text>
			...
			<Flex alignItems={'center'}>
				...
				<Box>
					...
					<Text mt={'8px'} fontWeight={600} fontSize={'8.5px'}>percentage of your total trips this week</Text>
				</Box>
			</Flex>
			...
			<Flex alignItems={'center'}>
				...
				<Box>
					<Text as={'h2'} color={'hsla(0, 0%, 33%, 0.7)'} fontWeight={600} fontSize={20.5}>Yesterday</Text>
					<Text mt={'8px'} fontWeight={600} fontSize={'8.5px'}>percentage of your total trips this week</Text>
				</Box>
			</Flex>
			...
			<Flex alignItems={'center'}>
				...
				<Box>
					<Text as={'h2'} color={'hsla(0, 0%, 33%, 0.7)'} fontWeight={600} fontSize={20.5}>Monday</Text>
					<Text mt={'8px'} fontWeight={600} fontSize={'8.5px'}>percentage of your total trips this week</Text>
				</Box>
			</Flex>
		</Flex>
